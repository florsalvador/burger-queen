...
function ProductRow({ qty, product, subtotal, removeProduct } : ProductRowProps) {
  ...
  return (
    <div className="relative grid grid-cols-[20%,80%] gap-2 bg-white border rounded-md p-3 text-sm leading-tight my-2">
      ...
      <div>
        ...
        <div className="flex justify-between mt-2">
          <div className="flex gap-2 items-center">
            <button className="py-1 px-2 bg-slate-200 disabled:bg-slate-50 disabled:text-gray-400" 
              onClick={() => handleUpdate(quantity - 1)} disabled={quantity == 1}>-</button>
            {quantity}
      ...
      <button className="absolute top-0 right-0 py-1 px-2 text-slate-400" 
